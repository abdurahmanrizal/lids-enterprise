            ...
            <aside>
                ...
                <div class="mb-5">
                    <div class="card">
                        ...
                        <div class="list-group list-group-flush">
                            <?
                                $sqlNewArticle   = "SELECT * FROM blog WHERE YEAR(date) = date('Y') AND status='1'";
                            ...
                            ?>
                                ...
                                <a class="list-group-item list-group-item-action flex-column align-items-start" href="blog.php?id=<?=$rowNewArticle['ID']?>">
                                    <div class="row">
                                        <div class="col-12">
