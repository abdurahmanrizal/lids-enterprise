    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          ...
          <img src="img/owner_resize.jpg" alt="" width="175" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h4 class="text-white mt-0">Lidia Lavigne</h4>
          <br>
          <p class="text-white-50 mb-4">A Passioned & Inspiring Womenpreneur with Almost 20 Years Experiences in Hospitality Business and 9 Years in Entrepreneurship. A Founder of Bali Lids Villa Management.</p>
        ...
        <div class="col-lg-6 col-md-6 text-center">
          ...
          <div class="col-lg-6 col-md-6 text-center">
            <div class="mt-5">
              ...
              <!-- <div class="row ml-life-coach">
                <div class="col-lg-12 col-md-12">
                <ul class="life-coach-bullets p-3">
                  <li class="text-muted mb-0 text-left"><i class="far fa-dot-circle pr-2"></i>Hypnoterapy</li>
                  <li class="text-muted mb-0 text-left"><i class="far fa-dot-circle pr-2"></i>Quantum Self Healing</li>
                  <li class="text-muted mb-0 text-left"><i class="far fa-dot-circle pr-2"></i>Self Healing</li>
                  <li class="text-muted mb-0 text-left"><i class="far fa-dot-circle pr-2"></i>Self Love</li>
                </ul>
                </div>
